<template>
    <section id="footer_nav" :class="footer_nav_class">
        <template v-for="(footerNav, index) in footerNavs">
            <nav :id="index" v-if="index.includes('footer')" class="nav  bg-dark justify-content-center">
                <template v-for="nav_item in footerNav">
                    <div :id="nav_item.slug.replace(new RegExp('/', 'g'), '')" class="nav-link">
